...
#Initialize ID list
horizon_ID <- vector('list', length(horizon_use$ï..Site))
...
for(i in 1:length(data$ID)){
  data$Site[i] <- horizon_use$ï..Site[i]
  data$ID[i] <- paste(horizon_use$ï..Site[i], horizon_use$Horizon[i], sep = '_')
...
site_list <- unique(horizon_use$ï..Site)
...
```{r}
pTALL_somp + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
panel.background = element_blank(), axis.line = element_line(colour = "black"))

pTALL_somc + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
panel.background = element_blank(), axis.line = element_line(colour = "black"))

pTALL_soma + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
panel.background = element_blank(), axis.line = element_line(colour = "black"))

pTALL_micRat + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
panel.background = element_blank(), axis.line = element_line(colour = "black"))
...
pDELA_somp <- ggplot(NULL, aes(x = t_1)) + 
    geom_line(data = minODE2_d, aes(y = SOM_1), color = 'blue') +
    geom_line(data = meanODE2_d, aes(y = SOM_1), color = 'red') +
    xlab('Time (hrs)') + ylab('Delta SOMP (g/cm2)')

pBLAN_somp <- ggplot(NULL, aes(x = t_1)) + 
    geom_line(data = minODE18_d, aes(y = SOM_1), color = 'blue') +
    geom_line(data = meanODE18_d, aes(y = SOM_1), color = 'red') +
    xlab('Time (hrs)') + ylab('Delta SOMP (g/cm2)')

pHARV_somp <- ggplot(NULL, aes(x = t_1)) + 
    geom_line(data = minODE19_d, aes(y = SOM_1), color = 'blue') +
    geom_line(data = meanODE19_d, aes(y = SOM_1), color = 'red') +
    xlab('Time (hrs)') + ylab('Delta SOMP (g/cm2)')
